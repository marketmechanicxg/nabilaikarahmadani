...
const ringTexts = [
  'Galaxy of love From Prince A',//untuk deskripsi planet layer 1
  "I love you",//untuk deskripsi planet layer 2
  "♡Love u So muchh sayangku♡",//untuk deskripsi planet layer 3
  "05/02/2026",//untuk deskripsi planet layer 4
...
function createHintText() {
  ...
  const context = canvas.getContext('2d');
  const fontSize = 50;
  const text = 'Love u So muchh sayangku';
